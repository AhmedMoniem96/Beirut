...
def build_login_stylesheet() -> str:
    ...
    parts.extend([
        ...
        f"#LoginDialog QLineEdit#DSTextField {{ border: 1px solid rgba(218, 190, 140, 0.55); border-radius: 18px; padding: 16px 24px; padding-right: 32px; min-height: 56px; background-color: rgba(255,255,255,0.97); color: #1A0F08; font-size: 15pt; font-weight: 600; letter-spacing: 0.5px; selection-background-color: {accent}; selection-color: #1A0F08; background-clip: padding; }}",
