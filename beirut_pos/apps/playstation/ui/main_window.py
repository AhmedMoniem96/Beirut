...
class MainWindow(QMainWindow):
    def __init__(self, current_user):
        ...
        self.act_print_bar = QAction(self)
        self.act_print_bar.triggered.connect(self._print_bar)
        bar.addAction(self.act_print_bar)
    ...
    def _apply_texts(self, *_args):
        ...
        self.act_print_bar.setText(texts.get("main.order.print_bar"))
