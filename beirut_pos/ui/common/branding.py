...
def build_login_stylesheet() -> str:
    ...
    parts.extend([
        ...
        f"#LoginDialog QLineEdit#DSTextField {{ border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 18px; padding: 18px 24px; padding-left: 40px; min-height: 56px; background-color: rgba(255,255,255,0.98); color: #1A0F08; font-size: 15pt; letter-spacing: 0.4px; selection-background-color: {accent}; selection-color: #1A0F08; background-clip: padding; }}",
