...
def build_login_stylesheet() -> str:
    ...
    parts.extend([
        ...
        f"#LoginDialog QFrame#DSFormField {{ background-color: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.16); border-radius: 18px; }}",
        f"#LoginDialog QFrame#DSFormField[data-focused=\"true\"] {{ border-color: {accent}; background-color: rgba(255,255,255,0.14); }}",
        ...
        f"#LoginDialog QLineEdit#DSTextField {{ border: 1px solid rgba(255, 255, 255, 0.2); border-radius: 22px; padding: 16px 22px; padding-left: 42px; min-height: 54px; background-color: rgba(255,255,255,0.98); color: #1A0F08; font-size: 15pt; letter-spacing: 0.4px; selection-background-color: {accent}; selection-color: #1A0F08; background-clip: padding; }}",
