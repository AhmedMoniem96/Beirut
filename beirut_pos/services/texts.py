...
DEFAULT_TEXTS: Dict[str, str] = {
    ...
    "login.empty_fields": "يرجى إدخال اسم المستخدم وكلمة المرور.",
    "login.unexpected_error": "تعذر تنفيذ تسجيل الدخول حالياً. حاول مرة أخرى أو تواصل مع الدعم.",
    ...
    "receipt.cashier.client_name": "العميل: {client_name}",
    "receipt.cashier.order_id": "رقم الطلب: {order_id}",
    "receipt.cashier.opened_at": "وقت الفتح: {timestamp}",
    "receipt.cashier.closed_at": "وقت الإغلاق: {timestamp}",
