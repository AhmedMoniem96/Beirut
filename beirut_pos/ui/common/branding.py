...
def build_main_window_stylesheet() -> str:
    ...
    parts.extend(
        [
            ...
            f"QWidget#TablesPage, QWidget#OrderPage {{ background-color: {surface}; border-radius: 28px; margin: 18px; padding: 16px; box-shadow: {SHADOWS.soft}; }}",
            ...
            "QFrame#SideNavigation { background-color: rgba(22,13,8,0.92); border-radius: 20px; border: 1px solid rgba(255,255,255,0.12); box-shadow: 0 18px 48px rgba(0,0,0,0.32); }",
            f"QFrame#SideNavigation QToolButton {{ color: {text}; font-weight: 700; border-radius: 14px; padding: 10px 14px; text-align: right; }}",
            "QFrame#SideNavigation QToolButton + QToolButton { margin-top: 6px; }",
            f"QFrame#SideNavigation QToolButton:checked {{ background: rgba(212,160,94,0.18); color: {text}; border: 1px solid rgba(212,160,94,0.6); }}",
            f"QFrame#SideNavigation QToolButton:hover {{ background: rgba(255,255,255,0.06); color: {text}; }}",
